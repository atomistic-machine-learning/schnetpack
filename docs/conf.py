...
project = "SchNetPack"
copyright = "2023, Kristof T. Schütt, Stefan S. P. Hessmann, Niklas W. A. Gebauer, Jonas Lederer, Michael Gastegger"
author = "Kristof T. Schütt, Stefan S. P. Hessmann, Niklas W. A. Gebauer, Jonas Lederer, Michael Gastegger"

# The version info for the project you're documenting, acts as replacement for
# |version| and |release|, also used in various other places throughout the
# built documents.
#
# Read from the installed package so this never drifts from
# schnetpack.__version__, which pyproject.toml also builds from.
try:
    # The full version, including alpha/beta/rc tags.
    release = get_version("schnetpack")
except PackageNotFoundError:
    # Docs built without installing the package (Read the Docs installs it).
    release = "0.0.0"
# The short X.Y version.
_m = re.match(r"(\d+\.\d+)", release)
version = _m.group(1) if _m else release
...
latex_documents = [
    (
        ...
        "Kristof T. Schütt, Stefan S. P. Hessmann, Niklas W. A. Gebauer, Jonas Lederer, Michael Gastegger",
        "manual",
    )
]
