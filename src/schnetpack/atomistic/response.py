...
__all__ = ["Forces", "Strain", "Response", "SplitShielding"]
...
class SplitShielding(nn.Module):
    """
    Output module for splitting the overall shielding tensor predicted by the network by atom types. This can e.g.
    be used to provide different weights to H or C chemical shifts in the loss function.
    """
