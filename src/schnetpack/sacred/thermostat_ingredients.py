...
def get_langevin_thermostat(bath_temperature, time_constant):
    thermostat_info(
        name="Langevin", temperature=bath_temperature, addition=time_constant
    )
...
def get_piglet_thermostat(bath_temperature, gle_file):
    thermostat_info(name="PiGLET", temperature=bath_temperature, addition=gle_file)
...
def get_berendsen_thermostat(bath_temperature, time_constant):
    thermostat_info(
        name="Berendsen", temperature=bath_temperature, addition=time_constant
    )
    return BerendsenThermostat(
        temperature_bath=bath_temperature, time_constant=time_constant
    )


@thermostat_ingredient.capture
def get_gle_thermostat(bath_temperature, gle_file):
    thermostat_info(name="GLE", temperature=bath_temperature, addition=gle_file)
    return GLEThermostat(temperature_bath=bath_temperature, gle_file=gle_file)


@thermostat_ingredient.capture
def get_pile_local_thermostat(bath_temperature, time_constant):
    thermostat_info(
        name="local PILE", temperature=bath_temperature, addition=time_constant
    )
    return PILELocalThermostat(
        temperature_bath=bath_temperature, time_constant=time_constant
    )
...
def get_pile_global_thermostat(bath_temperature, time_constant):
    thermostat_info(
        name="global PILE", temperature=bath_temperature, addition=time_constant
    )
    return PILEGlobalThermostat(
        temperature_bath=bath_temperature, time_constant=time_constant
    )
...
def get_trmpmd_thermostat(bath_temperature, damping):
    thermostat_info(name="TRPMD", temperature=bath_temperature, addition=damping)
    return TRPMDThermostat(bath_temperature, damping)


@thermostat_ingredient.capture
def get_nhc_thermostat(
    bath_temperature,
    time_constant,
    chain_length,
    multi_step,
    ...
    thermostat_info(name=name, temperature=bath_temperature, addition=time_constant)
    return NHCThermostat(
        bath_temperature,
        time_constant,
...
@thermostat_ingredient.capture
def get_nhc_ring_polymer_thermostat(
    bath_temperature,
    time_constant,
    chain_length,
    multi_step,
    ...
    thermostat_info(name=name, temperature=bath_temperature, addition=time_constant)
    return NHCRingPolymerThermostat(
        bath_temperature,
        time_constant,
        chain_length=chain_length,
        integration_order=integration_order,
