...
if __name__ == '__main__':
    ...
    data_subparsers = main_parser.add_subparsers(dest='dataset',
                                                 help='Select dataset')
    ...
    qm9_parser.add_argument('--remove_uncharacterized',
                            help='Remove uncharacterized molecules from QM9',
                            type=bool, default='False')

    md17_parser = data_subparsers.add_parser('md17', help='MD17 datasets')
    md17_parser.add_argument('molecule',
                            help='Molecule dataset',
                            choices=dset.MD17.existing_datasets)
