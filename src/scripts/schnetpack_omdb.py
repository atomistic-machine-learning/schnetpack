...
if __name__ == '__main__':
    ...
    omdb = spk.datasets.OrganicMaterialsDatabase(args.datapath, args.cutoff,
                                                 download=True,
                                                 properties=[
                                                     train_args.property])
    ...
    np.savez(split_path, train_idx=idx[:9000], val_idx=idx[9000:10000],
             test_idx=idx[-2500:])
    ...
    if args.mode == 'train':
        ...
        logging.info('Training set statistics: mean=%.3f, stddev=%.3f' % (
